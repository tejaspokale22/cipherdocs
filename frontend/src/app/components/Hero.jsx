      ...
      <div className="mx-auto flex w-full max-w-[90vw] flex-col items-center gap-10 px-4 sm:px-6 md:gap-12 lg:flex-row lg:items-center lg:gap-16 lg:px-8">
        ...
        <div className="flex-1 space-y-4 text-center lg:text-left">
          ...
          <div className="flex flex-col gap-2 sm:gap-3">
            <div className="flex items-center gap-3 rounded-xl bg-black/2 px-3 py-2 sm:gap-4 sm:rounded-2xl sm:px-4 sm:py-3">
          ...
          <div className="flex flex-col gap-3 pt-4 sm:flex-row sm:flex-wrap sm:justify-center sm:gap-4 lg:justify-start">
            ...
            <button className="cursor-pointer rounded-lg bg-black/5 px-5 py-3 text-sm font-medium text-black hover:bg-black/10 sm:px-7 sm:py-4 sm:text-base">
              Verify Certificate
            </button>
          </div>
        </div>
